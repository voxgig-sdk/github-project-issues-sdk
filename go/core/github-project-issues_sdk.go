...
type GithubProjectIssuesSDK struct {
	Mode     string
...
func (sdk *GithubProjectIssuesSDK) OptionsMap() map[string]any {
...
func (sdk *GithubProjectIssuesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GithubProjectIssuesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GithubProjectIssuesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GithubProjectIssuesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *GithubProjectIssuesSDK {
	...
	sdk := NewGithubProjectIssuesSDK(sdkopts)
	sdk.Mode = "test"
