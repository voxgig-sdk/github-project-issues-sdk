...
const testSeed = `map[string]any{"entity": map[string]any{"coffee": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "coffee_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "donate_rest_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "portfolio_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "repository_detail_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "repository_issue_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
