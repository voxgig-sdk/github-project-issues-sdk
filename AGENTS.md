# GithubProjectIssues SDK — Agent Guide
...
**Entities** (7): `Coffee`, `CoffeeDomain`, `DonateRestController`, `PortfolioController`, `RepositoryDetailDomain`, `RepositoryIssueDomain`, `Version`.
