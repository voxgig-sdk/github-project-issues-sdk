// Command GithubProjectIssues-mcp is an MCP server exposing the GithubProjectIssues
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GithubProjectIssues_list  — list records of an entity
//	GithubProjectIssues_load  — load a single record of an entity
//
