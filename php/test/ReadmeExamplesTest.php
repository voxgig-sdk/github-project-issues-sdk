...
// GithubProjectIssues SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GithubProjectIssuesSDK::test)
...
{
    private const SDK_CLASS = 'GithubProjectIssuesSDK';
    ...
    private const SDK_BASE = 'githubprojectissues_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../githubprojectissues_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
