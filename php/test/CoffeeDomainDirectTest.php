...
class CoffeeDomainDirectTest extends TestCase
{
    public function test_direct_list_coffee_domain(): void
    {
        $setup = coffee_domain_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-coffee_domain", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
