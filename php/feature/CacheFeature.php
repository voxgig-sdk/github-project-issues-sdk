...
// GithubProjectIssues SDK cache feature
...
class GithubProjectIssuesCacheFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _through(GithubProjectIssuesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
