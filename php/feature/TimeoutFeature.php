...
// GithubProjectIssues SDK timeout feature
...
class GithubProjectIssuesTimeoutFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _with_timeout(GithubProjectIssuesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GithubProjectIssuesContext $_ctx, float $ms): void
    {
        $client = $this->client;
