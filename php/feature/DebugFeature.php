...
// GithubProjectIssues SDK debug feature
...
class GithubProjectIssuesDebugFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _finish(GithubProjectIssuesContext $ctx, bool $ok): void
    {
