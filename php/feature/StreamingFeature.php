...
// GithubProjectIssues SDK streaming feature
...
class GithubProjectIssuesStreamingFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _iterate(GithubProjectIssuesResult $result): \Generator
    {
    ...
    private function _streamable(GithubProjectIssuesContext $ctx): bool
    {
