...
// GithubProjectIssues SDK paging feature
...
class GithubProjectIssuesPagingFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _is_list(GithubProjectIssuesContext $ctx): bool
    {
