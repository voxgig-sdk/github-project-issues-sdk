...
// GithubProjectIssues SDK clienttrack feature
...
class GithubProjectIssuesClienttrackFeature extends GithubProjectIssuesBaseFeature
{
    ...
    public function PostConstruct(GithubProjectIssuesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GithubProjectIssues-SDK';
