...
// GithubProjectIssues SDK ratelimit feature
...
class GithubProjectIssuesRatelimitFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _acquire(GithubProjectIssuesContext $ctx): void
    {
    ...
    private function _track(GithubProjectIssuesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
