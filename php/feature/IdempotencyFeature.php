...
// GithubProjectIssues SDK idempotency feature
...
class GithubProjectIssuesIdempotencyFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _mutating(GithubProjectIssuesContext $ctx): bool
    {
