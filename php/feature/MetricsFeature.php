...
// GithubProjectIssues SDK metrics feature
...
class GithubProjectIssuesMetricsFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _record(GithubProjectIssuesContext $ctx, bool $ok): void
    {
