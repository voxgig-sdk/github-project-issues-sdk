...
class DonateRestControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "donate_rest_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DonateRestControllerEntity($this->_client, $opts);
    }

    /**
     * @param DonateRestController|array $args DonateRestController data (assoc-array) to store.
     */
    ...
    /**
     * @return DonateRestController|array The current DonateRestController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DonateRestController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DonateRestController fields).
     */
     ...
     *
     * @param DonateRestControllerListMatch|array|null $reqmatch Match filter (any subset
     *   of DonateRestController fields) as an assoc-array; DonateRestControllerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DonateRestController[]|array A list of DonateRestController items as assoc-arrays at
