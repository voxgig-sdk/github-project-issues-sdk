...
class RepositoryDetailDomainEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_detail_domain";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryDetailDomainEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryDetailDomain|array $args RepositoryDetailDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryDetailDomain|array The current RepositoryDetailDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryDetailDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryDetailDomain fields).
     */
    ...
    /**
     * Load a single RepositoryDetailDomain.
     *
     * @param RepositoryDetailDomainLoadMatch|array|null $reqmatch Match criteria (id/query
    ...
    /**
     * List RepositoryDetailDomain items matching the given filter.
     *
     * @param RepositoryDetailDomainListMatch|array|null $reqmatch Match filter (any subset
