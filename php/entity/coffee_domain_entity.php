...
class CoffeeDomainEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CoffeeDomainEntity($this->_client, $opts);
    }

    /**
     * @param CoffeeDomain|array $args CoffeeDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return CoffeeDomain|array The current CoffeeDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CoffeeDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CoffeeDomain fields).
     */
    ...
    /**
     * List CoffeeDomain items matching the given filter.
     *
     * @param CoffeeDomainListMatch|array|null $reqmatch Match filter (any subset
