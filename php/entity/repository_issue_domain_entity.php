...
class RepositoryIssueDomainEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "repository_issue_domain";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RepositoryIssueDomainEntity($this->_client, $opts);
    }

    /**
     * @param RepositoryIssueDomain|array $args RepositoryIssueDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return RepositoryIssueDomain|array The current RepositoryIssueDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RepositoryIssueDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RepositoryIssueDomain fields).
     */
    ...
    /**
     * List RepositoryIssueDomain items matching the given filter.
     *
     * @param RepositoryIssueDomainListMatch|array|null $reqmatch Match filter (any subset
     *   of RepositoryIssueDomain fields) as an assoc-array; RepositoryIssueDomainListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RepositoryIssueDomain[]|array A list of RepositoryIssueDomain items as assoc-arrays at
