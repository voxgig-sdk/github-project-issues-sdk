...
//     (\`new GithubProjectIssuesSDK(...)\` / \`GithubProjectIssuesSDK.test(...)\` become
//     \`GithubProjectIssuesSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"coffee":{"test01":{"id":"test01"}},"coffee_domain":{"test01":{"id":"test01"}},"donate_rest_controller":{"test01":{"id":"test01"}},"portfolio_controller":{"test01":{"id":"test01"}},"repository_detail_domain":{"test01":{"id":"test01"}},"repository_issue_domain":{"test01":{"id":"test01"}},"version":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new GithubProjectIssuesSDK(...)\` and any
// \`GithubProjectIssuesSDK.test(...)\`) to a seeded test-mode client, and give
