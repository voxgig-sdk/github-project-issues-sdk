...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.GITHUBPROJECTISSUES_TEST_LIVE ||
    'TRUE' === process.env.GITHUBPROJECTISSUES_TEST_OVERRIDE
  ) {
  ...
  m.GITHUBPROJECTISSUES_TEST_EXPLAIN = process.env.GITHUBPROJECTISSUES_TEST_EXPLAIN || m.GITHUBPROJECTISSUES_TEST_EXPLAIN
