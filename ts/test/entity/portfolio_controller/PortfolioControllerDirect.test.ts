...
describe('PortfolioControllerDirect', async () => {
  ...
  test('direct-list-portfolio_controller', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-portfolio_controller', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUBPROJECTISSUES_TEST_PORTFOLIO_CONTROLLER_ENTID']
