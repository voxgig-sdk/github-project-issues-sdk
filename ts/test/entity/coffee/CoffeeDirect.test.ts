...
describe('CoffeeDirect', async () => {
  ...
  test('direct-list-coffee', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-coffee', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GITHUBPROJECTISSUES_TEST_COFFEE_ENTID']
