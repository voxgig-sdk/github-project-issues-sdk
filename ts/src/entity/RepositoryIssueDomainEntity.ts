...
class RepositoryIssueDomainEntity extends GithubProjectIssuesEntityBase<RepositoryIssueDomain> {
  ...
  constructor(client: GithubProjectIssuesSDK, entopts: any) {
    ...
    this.Name = 'RepositoryIssueDomain'
  }


  make(this: RepositoryIssueDomainEntity) {
    return new RepositoryIssueDomainEntity(this._client, this.entopts())
  }
  ...
  async list(this: any, reqmatch?: RepositoryIssueDomainListMatch, ctrl?: Control): Promise<RepositoryIssueDomain[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<RepositoryIssueDomain[]> return stays clean under strict null checks.
