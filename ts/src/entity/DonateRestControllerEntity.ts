...
class DonateRestControllerEntity extends GithubProjectIssuesEntityBase<DonateRestController> {
  ...
  constructor(client: GithubProjectIssuesSDK, entopts: any) {
    ...
    this.Name = 'DonateRestController'
  }


  make(this: DonateRestControllerEntity) {
    return new DonateRestControllerEntity(this._client, this.entopts())
  }
  ...
  async list(this: any, reqmatch?: DonateRestControllerListMatch, ctrl?: Control): Promise<DonateRestController[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<DonateRestController[]> return stays clean under strict null checks.
