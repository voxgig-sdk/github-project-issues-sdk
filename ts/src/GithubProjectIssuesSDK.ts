...
export type * from './GithubProjectIssuesTypes'
...
class GithubProjectIssuesSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new GithubProjectIssuesSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return GithubProjectIssuesSDK.test(testopts, sdkopts)
  }


  toJSON() {
    return { name: 'GithubProjectIssues' }
  }

  toString() {
    return 'GithubProjectIssues ' + this._utility.struct.jsonify(this.toJSON())
  }
...
const SDK = GithubProjectIssuesSDK
