...
Learn more about iRonoc API at [ironoc.net](https://ironoc.net).
...
This SDK exposes the API as a small set of **semantic entities** — Coffee, CoffeeDomain, DonateRestController, PortfolioController, RepositoryDetailDomain, RepositoryIssueDomain and Version — that you
...
| --- | --- | --- |
| **Coffee** | The Coffee entity (list, update). | `/api/coffees` |
| **CoffeeDomain** | The CoffeeDomain entity (list). | `/api/coffees-graph-ql` |
| **DonateRestController** | The DonateRestController entity (list). | `/api/donate-items` |
| **PortfolioController** | The PortfolioController entity (list). | `/api/portfolio-items` |
| **RepositoryDetailDomain** | The RepositoryDetailDomain entity (list, load). | `/api/get-repo-detail` |
| **RepositoryIssueDomain** | The RepositoryIssueDomain entity (list). | `/api/get-repo-issue/{username}/{repository}/` |
| **Version** | The Version entity (load). | `/api/application/version` |

The operations available across these entities are **load**, **list**, **update** — see each entity's
