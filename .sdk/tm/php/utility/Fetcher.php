...
class GithubProjectIssuesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GithubProjectIssuesSDK/1.0)';
    ...
    public static function call(GithubProjectIssuesContext $ctx, string $fullurl, array $fetchdef): array
    {
