...
// GithubProjectIssues SDK rbac feature
...
class GithubProjectIssuesRbacFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _required(GithubProjectIssuesContext $ctx): ?string
    {
    ...
    private function _reject(GithubProjectIssuesContext $ctx, string $required): void
    {
    ...
    private function _track(GithubProjectIssuesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
