...
// GithubProjectIssues SDK telemetry feature
...
class GithubProjectIssuesTelemetryFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _close(GithubProjectIssuesContext $ctx, bool $ok): void
    {
