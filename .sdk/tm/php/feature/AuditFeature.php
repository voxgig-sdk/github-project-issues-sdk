...
// GithubProjectIssues SDK audit feature
...
class GithubProjectIssuesAuditFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _emit(GithubProjectIssuesContext $ctx, string $outcome): void
    {
