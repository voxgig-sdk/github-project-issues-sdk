...
// GithubProjectIssues SDK proxy feature
...
class GithubProjectIssuesProxyFeature extends GithubProjectIssuesBaseFeature
{
    ...
    public function init(GithubProjectIssuesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GithubProjectIssuesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
