...
// GithubProjectIssues SDK netsim feature
...
class GithubProjectIssuesNetsimFeature extends GithubProjectIssuesBaseFeature
{
    ...
    private function _simulate(GithubProjectIssuesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GithubProjectIssuesContext $ctx, array $applied): void
    {
        $client = $this->client;
