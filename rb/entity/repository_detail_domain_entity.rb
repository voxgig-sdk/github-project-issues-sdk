...
class RepositoryDetailDomainEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "repository_detail_domain"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    RepositoryDetailDomainEntity.new(@_client, opts)
  end
  ...
  # @return [RepositoryDetailDomain, Hash] the current RepositoryDetailDomain data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RepositoryDetailDomain fields)
  def match_get
  ...
  #
  # @param reqmatch [RepositoryDetailDomainLoadMatch, Hash, nil] match criteria (id/query fields)
  ...
  #
  # @param reqmatch [RepositoryDetailDomainListMatch, Hash, nil] match filter (any subset of RepositoryDetailDomain fields)
  # @param ctrl [Object, nil] optional per-call control
