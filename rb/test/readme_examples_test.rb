...
#      offline in seeded test mode (GithubProjectIssuesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GithubProjectIssues_sdk.rb")
  SDK_CLASS = "GithubProjectIssuesSDK"
  ...
  SDK_BASE = "GithubProjectIssues_sdk"
