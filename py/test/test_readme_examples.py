# GithubProjectIssues SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GithubProjectIssuesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GithubProjectIssuesSDK(...) and GithubProjectIssuesSDK.test(...) become
#      GithubProjectIssuesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "githubprojectissues_sdk"
_SDK_CLASS = "GithubProjectIssuesSDK"
...
_ENTITIES = {
    "Coffee": "coffee",
    "CoffeeDomain": "coffee_domain",
    "DonateRestController": "donate_rest_controller",
    "PortfolioController": "portfolio_controller",
    "RepositoryDetailDomain": "repository_detail_domain",
    "RepositoryIssueDomain": "repository_issue_domain",
    "Version": "version",
}
