...
class TestCoffeeDomainEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.CoffeeDomain(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.CoffeeDomain(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        coffee_domain_ref01_list_result = coffee_domain_ref01_ent.list(coffee_domain_ref01_match, None)
