...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return GithubProjectIssuesError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except GithubProjectIssuesError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = GithubProjectIssuesResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = GithubProjectIssuesSDK.test(None, None)
        ...
        class TestInitFeature(GithubProjectIssuesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GithubProjectIssuesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = GithubProjectIssuesSDK({
            "system": {
                "fetch": mock_fetch,
            },
        })
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = GithubProjectIssuesSDK({
            "system": {
                "fetch": mock_fetch,
            },
        })
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GithubProjectIssuesSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GithubProjectIssuesSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = GithubProjectIssuesOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GithubProjectIssuesSDK.test(None, setup_opts)
