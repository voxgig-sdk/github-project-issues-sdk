...
class DonateRestControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DonateRestControllerEntity(self._client, opts)
    ...
    def data_get(self) -> DonateRestController:
    ...
    def match_get(self) -> DonateRestController:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DonateRestController]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DonateRestController().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
