...
class PortfolioControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PortfolioControllerEntity(self._client, opts)
    ...
    def data_get(self) -> PortfolioController:
    ...
    def match_get(self) -> PortfolioController:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PortfolioController]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PortfolioController().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
