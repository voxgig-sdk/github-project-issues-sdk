...
class CoffeeDomainEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CoffeeDomainEntity(self._client, opts)
    ...
    def data_get(self) -> CoffeeDomain:
    ...
    def match_get(self) -> CoffeeDomain:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CoffeeDomain]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CoffeeDomain().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
