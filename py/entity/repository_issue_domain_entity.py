...
class RepositoryIssueDomainEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepositoryIssueDomainEntity(self._client, opts)
    ...
    def data_get(self) -> RepositoryIssueDomain:
    ...
    def match_get(self) -> RepositoryIssueDomain:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RepositoryIssueDomain]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RepositoryIssueDomain().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
