...
local GithubProjectIssuesSDK = {}
GithubProjectIssuesSDK.__index = GithubProjectIssuesSDK
...
GithubProjectIssuesSDK._make_feature = _make_feature


function GithubProjectIssuesSDK.new(options)
  local self = setmetatable({}, GithubProjectIssuesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GithubProjectIssuesSDK:options_map()
...
function GithubProjectIssuesSDK:get_utility()
  return Utility.copy(self._utility)
end


function GithubProjectIssuesSDK:get_root_ctx()
  return self._rootctx
end


function GithubProjectIssuesSDK:prepare(fetchargs)
...
function GithubProjectIssuesSDK:direct(fetchargs)
  local utility = self._utility
...
function GithubProjectIssuesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = GithubProjectIssuesSDK.new(sdkopts)
  sdk.mode = "test"
