...
local SDK_MODULE = "github-project-issues_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["coffee"] = { ["test01"] = { id = "test01" } }, ["coffee_domain"] = { ["test01"] = { id = "test01" } }, ["donate_rest_controller"] = { ["test01"] = { id = "test01" } }, ["portfolio_controller"] = { ["test01"] = { id = "test01" } }, ["repository_detail_domain"] = { ["test01"] = { id = "test01" } }, ["repository_issue_domain"] = { ["test01"] = { id = "test01" } }, ["version"] = { ["test01"] = { id = "test01" } } } }'
