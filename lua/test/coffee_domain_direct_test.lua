...
describe("CoffeeDomainDirect", function()
  it("should direct-list-coffee_domain", function()
    local setup = coffee_domain_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-coffee_domain", setup.live and "live" or "unit")
...
function coffee_domain_direct_setup(mockres)
