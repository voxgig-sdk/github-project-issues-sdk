-- PortfolioController direct test
...
describe("PortfolioControllerDirect", function()
  it("should direct-list-portfolio_controller", function()
    local setup = portfolio_controller_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-portfolio_controller", setup.live and "live" or "unit")
...
function portfolio_controller_direct_setup(mockres)
