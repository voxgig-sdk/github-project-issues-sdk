...
describe("DonateRestControllerDirect", function()
  it("should direct-list-donate_rest_controller", function()
    local setup = donate_rest_controller_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-donate_rest_controller", setup.live and "live" or "unit")
...
function donate_rest_controller_direct_setup(mockres)
