...
describe("CoffeeDirect", function()
  it("should direct-list-coffee", function()
    local setup = coffee_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-coffee", setup.live and "live" or "unit")
...
function coffee_direct_setup(mockres)
