...
local RepositoryIssueDomainEntity = {}
RepositoryIssueDomainEntity.__index = RepositoryIssueDomainEntity


function RepositoryIssueDomainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryIssueDomainEntity)
  self._name = "repository_issue_domain"
  self._client = client
...
function RepositoryIssueDomainEntity:get_name()
  return self._name
end


function RepositoryIssueDomainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryIssueDomainEntity.new(self._client, opts)
end


function RepositoryIssueDomainEntity:data_set(args)
  if args ~= nil then
...
function RepositoryIssueDomainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryIssueDomainEntity:match_set(args)
  if args ~= nil then
...
function RepositoryIssueDomainEntity:match_get()
...
function RepositoryIssueDomainEntity:stream(action, args, callopts)
...
function RepositoryIssueDomainEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryIssueDomainEntity
