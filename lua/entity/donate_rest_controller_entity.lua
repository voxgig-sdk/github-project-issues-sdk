...
local DonateRestControllerEntity = {}
DonateRestControllerEntity.__index = DonateRestControllerEntity


function DonateRestControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DonateRestControllerEntity)
  self._name = "donate_rest_controller"
  self._client = client
...
function DonateRestControllerEntity:get_name()
  return self._name
end


function DonateRestControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DonateRestControllerEntity.new(self._client, opts)
end


function DonateRestControllerEntity:data_set(args)
  if args ~= nil then
...
function DonateRestControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DonateRestControllerEntity:match_set(args)
  if args ~= nil then
...
function DonateRestControllerEntity:match_get()
...
function DonateRestControllerEntity:stream(action, args, callopts)
...
---@param reqmatch DonateRestControllerListMatch
---@param ctrl? table
---@return DonateRestController[]
---@return string? err
function DonateRestControllerEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function DonateRestControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DonateRestControllerEntity
