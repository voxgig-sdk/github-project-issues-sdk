...
local PortfolioControllerEntity = {}
PortfolioControllerEntity.__index = PortfolioControllerEntity


function PortfolioControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PortfolioControllerEntity)
  self._name = "portfolio_controller"
  self._client = client
...
function PortfolioControllerEntity:get_name()
  return self._name
end


function PortfolioControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PortfolioControllerEntity.new(self._client, opts)
end


function PortfolioControllerEntity:data_set(args)
  if args ~= nil then
...
function PortfolioControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PortfolioControllerEntity:match_set(args)
  if args ~= nil then
...
function PortfolioControllerEntity:match_get()
...
function PortfolioControllerEntity:stream(action, args, callopts)
...
function PortfolioControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PortfolioControllerEntity
