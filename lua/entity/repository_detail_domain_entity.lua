...
local RepositoryDetailDomainEntity = {}
RepositoryDetailDomainEntity.__index = RepositoryDetailDomainEntity


function RepositoryDetailDomainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RepositoryDetailDomainEntity)
  self._name = "repository_detail_domain"
  self._client = client
...
function RepositoryDetailDomainEntity:get_name()
  return self._name
end


function RepositoryDetailDomainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RepositoryDetailDomainEntity.new(self._client, opts)
end


function RepositoryDetailDomainEntity:data_set(args)
  if args ~= nil then
...
function RepositoryDetailDomainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RepositoryDetailDomainEntity:match_set(args)
  if args ~= nil then
...
function RepositoryDetailDomainEntity:match_get()
...
function RepositoryDetailDomainEntity:stream(action, args, callopts)
...
function RepositoryDetailDomainEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RepositoryDetailDomainEntity
